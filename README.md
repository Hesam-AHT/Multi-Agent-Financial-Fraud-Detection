# Multi-Agent-Financial-Fraud-Detection
Multi-agent fraud detection pipeline for the Reply AI Challenge. Parallel multi-agent architecture with SCoT + Few-Shot prompts
...
**Reply AI-Agent Hackathon — Problem Statement 16 April 2026**
